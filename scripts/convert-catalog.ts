...
const CUISINE_CONSOLIDATION: Record<string, CuisineTag> = {
  ...
  tunisian: 'middle_eastern_african',
  algerian: 'middle_eastern_african',
  north_african: 'middle_eastern_african',
  west_african: 'middle_eastern_african',
  middle_eastern: 'middle_eastern_african',
  japanese: 'east_asian',
  korean: 'east_asian',
  chinese: 'east_asian',
  thai: 'east_asian',
